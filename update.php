...
<head>
    ...
    <style>
        ...
        .custom-navbar-menu .custom-btn-logout {
            background: white;
            color: #6a1b9a;
        ...
        .custom-navbar-menu .custom-btn-logout:hover {
            background: #4a148c;
            color: white;
        }
...
<nav class="custom-navbar" role="navigation" aria-label="Main Navigation">
    <div class="custom-navbar-container">
        ...
        <button class="custom-navbar-toggler" aria-expanded="false" aria-controls="customNavbarMenu" aria-label="Toggle navigation">
            &#9776;
        </button>
